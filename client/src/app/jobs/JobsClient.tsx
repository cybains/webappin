  ...
  return (
    <main className="max-w-5xl mx-auto px-4 py-8 min-h-screen bg-[var(--background)] text-[var(--foreground)]">
        ...
        <div className="flex flex-col gap-4 mb-8">
          {jobs.map((job) => {
            ...
            return (
              <div
                key={job.id}
                className="relative border rounded-2xl p-4 hover:shadow transition bg-[var(--card)] border-[var(--card-border)]"
              >
                {/* source banner */}
      ...
      <div className="sticky bottom-4 z-10">
        <div className="flex flex-wrap justify-center items-center gap-2 bg-[var(--card)]/80 backdrop-blur rounded-xl px-3 py-2 border border-[var(--card-border)]">
      ...
      {modalJob && (
        ...
        >
          <div
            className="max-w-3xl w-full max-h-[80vh] overflow-auto bg-[var(--card)] rounded-2xl shadow-xl border border-[var(--card-border)] p-4"
            onClick={(e) => e.stopPropagation()}
          >
